...
$.extend(Controller, {
    ...
    mousedown: function (event) {
        ...
        if (this.can('drawWall') && grid.isWalkableAt(gridX, gridY-4)) {
            this.drawWall(gridX, gridY-4);
            return;
        }
        if (this.can('eraseWall') && !grid.isWalkableAt(gridX, gridY-4)) {
            this.eraseWall(gridX, gridY-4);
        }
    },
